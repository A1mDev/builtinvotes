...
ifeq "$(ENGINE)" "orangeboxvalve"
	...
	OBJECTS += BuiltinVoteStyle_TF2.cpp
	BUILD_SUFFIX = 2.ep2v
endif
ifeq "$(ENGINE)" "left4dead"
	HL2SDK = $(HL2SDK_L4D)
	CFLAGS += -DSOURCE_ENGINE=8
	OBJECTS += BuiltinVoteStyle_L4D_Base.cpp BuiltinVoteStyle_L4D1.cpp
	BUILD_SUFFIX = 2.l4d
endif
ifeq "$(ENGINE)" "left4dead2"
	HL2SDK = $(HL2SDK_L4D2)
	CFLAGS += -DSOURCE_ENGINE=9
	OBJECTS += BuiltinVoteStyle_L4D_Base.cpp BuiltinVoteStyle_L4D2.cpp
	BUILD_SUFFIX = 2.l4d2
endif
ifeq "$(ENGINE)" "csgo"
	HL2SDK = $(HL2SDK_CSGO)
